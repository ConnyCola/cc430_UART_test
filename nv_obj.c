...
#define INFO_FLASH_LNK_ID_STARTBBB_ADDR          (0x1900)

// segment C for storing network configuration
#define INFO_FLASH_NWK_CFG_START_ADDR         (0x1800)
#define INFO_FLASH_NWK_CFG_SIZE               (128)

// segment D for storing link handle
#define INFO_FLASH_LNK_ID_START_ADDR          (0x1880)
#define INFO_FLASH_LNK_ID_SIZE                (128)
...
void nv_obj_init(void)
{
	...
	UCSCTL2 = FLLD_4 + 1;                   // Set DCO Multiplier for 1MHz
}
...
{
  uint8_t *Flash_ptrC = (uint8_t*) INFO_FLASH_NWK_CFG_START_ADDR;
  uint8_t *Flash_ptrD = (uint8_t*) INFO_FLASH_LNK_ID_START_ADDR;
